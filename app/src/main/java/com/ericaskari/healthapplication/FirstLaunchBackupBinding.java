...
public final class FirstLaunchBackupBinding implements ViewBinding {
  @NonNull
  ...
  private FirstLaunchBackupBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static FirstLaunchBackupBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FirstLaunchBackupBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.first_launch_backup, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FirstLaunchBackupBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FirstLaunchBackupBinding((ConstraintLayout) rootView,
          buttonPickBirthdateFirstLaunch, editTextLongTermIllness, firstName, height, lastName,
